...
class StockTransfer(models.Model):
    ...
    origin_school_unit = models.ForeignKey(SchoolUnit, related_name='origin_transfers', on_delete=models.CASCADE, verbose_name='Estoque de Origem')
    target_school_unit = models.ForeignKey(SchoolUnit, related_name='target_transfers', on_delete=models.CASCADE, verbose_name='Estoque de Destino')
    transfer_date = models.DateTimeField(auto_now=True, verbose_name='Data de Tranferência')
    transferred_by = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='Transferido por')
    ...
    def perform_transfer(self):
        ...
        stock_item_origin = StockItem.objects.filter(stock__school_unit=self.origin_school_unit,
